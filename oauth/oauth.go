...
import (
	"UdemyApp/bookstore_oauth-go/oauth/errors"
	"encoding/json"
	"fmt"
...
func AuthenticateRequest(request *http.Request) *errors.RestErr {
	...
	//http:.../resource?access_token=ssvssdf
...
func getAccessToken(accessTokenId string) (*accessToken, *errors.RestErr) {
	...
	if response == nil || response.Response == nil {
		return nil, errors.NewInternalServerError("invalid restclient response when tryit to get access token")
	}
